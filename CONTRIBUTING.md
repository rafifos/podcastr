# Contributing to Podcastr

Love Podcastr and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/rafifos/podcastr/issues?q=sort%3Aupdated-desc) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git remote add upstream https://github.com/rafifos/podcastr.git
    ```
...
owners to license your work under the terms of [The Unlicense](LICENSE).
